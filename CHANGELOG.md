...
### Added
- Initial release.
- `createLedgerAgent(options)` factory that wraps `fetch` and enforces spend caps.
...
- `agent.snapshot()` for inspecting the running totals and configured
  budget.
- Dual ESM + CJS build with TypeScript declarations.

[Unreleased]: https://github.com/laibuglione7993582-maker/ledger-agent/compare/v0.1.1...HEAD
[0.1.1]: https://github.com/laibuglione7993582-maker/ledger-agent/compare/v0.1.0...v0.1.1
[0.1.0]: https://github.com/laibuglione7993582-maker/ledger-agent/releases/tag/v0.1.0
