...
<img src="banner.jpg" alt="ledger-agent" width="100%" />

# ledger-agent

Governance wrapper for x402 payments — spend caps, transaction logs, and anomaly detection.

[![npm version](https://img.shields.io/npm/v/ledger-agent.svg?style=flat-square)](https://www.npmjs.com/package/ledger-agent)
[![npm downloads](https://img.shields.io/npm/dm/ledger-agent.svg?style=flat-square)](https://www.npmjs.com/package/ledger-agent)
[![bundle size](https://img.shields.io/bundlephobia/minzip/ledger-agent?style=flat-square)](https://bundlephobia.com/package/ledger-agent)
[![license](https://img.shields.io/npm/l/ledger-agent.svg?style=flat-square)](./LICENSE)
[![types](https://img.shields.io/npm/types/ledger-agent.svg?style=flat-square)](./dist/index.d.ts)

[npm](https://www.npmjs.com/package/ledger-agent) · [GitHub](https://github.com/laibuglione7993582-maker/ledger-agent)
